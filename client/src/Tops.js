    ...
    <main className="main">
      <div className="content">
        <ul className="tops-content">
          <li>
            <div className="tops">
              <img className="tops-image" src={tops1} alt="tops" />
              <div className="tops-name">
                <a href="tops.html">Solid V-Neck</a>
              </div>
          ...
          <li>
            <div className="tops">
              <img className="tops-image" src={tops2} alt="tops" />
              <div className="tops-name">
                <a href="tops.html">Hungarian Blouse</a>
              </div>
          ...
          <li>
            <div className="tops">
              <img className="tops-image" src={tops3} alt="tops" />
              <div className="tops-name">
                <a href="tops.html">70's Embroider Mexican Blouse</a>
              </div>
