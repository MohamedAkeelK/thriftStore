    ...
    <main className="main">
      <div className="content">
        <ul className="bags-content">
          <li>
            <div className="bags">
              <img className="bags-image" src={bags1} alt="bags" />
              <div className="bags-name">
                <a href="bags.html">Pochette Bag</a>
              </div>
          ...
          <li>
            <div className="bags">
              <img className="bags-image" src={bags2} alt="bags" />
              <div className="bags-name">
                <a href="bags.html">Channel Mini Flap</a>
              </div>
          ...
          <li>
            <div className="bags">
              <img className="bags-image" src={bags3} alt="bags" />
              <div className="bags-name">
                <a href="bags.html">Garafano Caged Crystal</a>
              </div>
