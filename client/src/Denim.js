    ...
    <main className="main">
      <div className="content">
        <ul className="denim-content">
          <li>
            <div className="denim">
              <img className="denim-image" src={denim1} alt="denim" />
              <div className="denim-name">
                <a href="denim.html">Vintage 501 Jeans</a>
              </div>
          ...
          <li>
            <div className="denim">
              <img className="denim-image" src={denim2} alt="denim" />
              <div className="denim-name">
                <a href="denim.html">Levi's Wedge Icon Jeans</a>
              </div>
              <div className="denim-brand">Levi's</div>
          ...
          <li>
            <div className="denim">
              <img className="denim-image" src={denim3} alt="denim" />
              <div className="denim-name">
                <a href="denim.html">Vintage Tucker Denim Jacket</a>
              </div>
              <div className="denim-brand">Levi's</div>
