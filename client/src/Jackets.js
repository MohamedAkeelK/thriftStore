        ...
        <ul className="jackets-content">
          <li>
            <div className="jackets">
              <img className="jackets-image" src={Jacket1} alt="jackets" />
              <div className="jackets-name">
                <a href="jacket.html">Denim Jacket</a>
              </div>
          ...
          <li>
            <div className="jackets">
              <img className="jackets-image" src={Jacket2} alt="jackets" />
              <div className="jackets-name">
                <a href="jacket.html">Leather Jacket</a>
              </div>
              <div className="jackets-brand">Louie</div>
              <div className="jackets-price">$50</div>
            </div>
          </li>
          <li>
            <div className="jackets">
              <img className="jackets-image" src={Jacket4} alt="jackets" />
              <div className="jackets-name">
                <a href="jacket.html">Womans Bomber</a>
              </div>
              <div className="jackets-brand">Cuchi</div>
